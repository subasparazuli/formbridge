                    ...
                    {success ? (
                        <div className="text-center py-4">
                            ...
                            <Link href="/login">
                                <Button
                                    variant="outline"
                                    className="mt-6 border-zinc-800 text-zinc-300 hover:text-white hover:bg-zinc-800"
                                >
                                    Back to Sign In
                                </Button>
                            </Link>
                        ...
                        <>
                            <div className="text-center mb-8">
                                ...
                                <p className="text-sm text-zinc-400">Get started with Formbridge for free</p>
                            </div>
